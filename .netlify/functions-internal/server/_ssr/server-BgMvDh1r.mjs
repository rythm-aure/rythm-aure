...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-6ScRSBte.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ClZDvCoc.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B7u-YB20.mjs"),
		import("./start-p5eoyp83.mjs"),
